        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsLibraryOwner = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_CartItems_LibraryBooks_LibraryBookId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_LibraryBooks_LibraryBookId",
                        column: x => x.LibraryBookId,
                        principalTable: "LibraryBooks",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_LibraryBookId",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesBooks_BookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_LibraryBookId",
                table: "OrderItems",
                column: "LibraryBookId");
